...
- ✔️ **Autocomplete** — every keyword, type, constant, and the full builtin library (325 builtins) with category labels and call signatures. Builtins that take arguments expand to a call template.

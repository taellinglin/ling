...
impl Token {
    ...
    pub fn is_keyword(&self) -> bool {
        matches!(self,
            Token::Bind | Token::Do | Token::Fn | Token::Mod | Token::Type |
            Token::If | Token::Else | Token::While | Token::For | Token::In |
            Token::Match | Token::Return | Token::Loop | Token::Break |
            Token::Continue | Token::Own | Token::Lend | Token::Share |
            Token::Move | Token::Copy | Token::Change | Token::Async |
            Token::Wait | Token::Spawn | Token::Post | Token::Give |
            Token::Fit | Token::Form | Token::Choose | Token::Can |
            Token::Stop | Token::Again | Token::Try | Token::Sure |
            Token::Maybe | Token::Pure | Token::Ok | Token::Bad |
            Token::NoneKw | Token::As | Token::Where
        )
    }
    ...
    pub fn is_type(&self) -> bool {
        matches!(self,
            Token::Num | Token::Text | Token::Bool |
            Token::Vec | Token::Map | Token::Tuple |
    ...
    pub fn is_operator(&self) -> bool {
        matches!(self,
            ...
            Token::Le | Token::Ge | Token::And | Token::Or | Token::Not |
            Token::Arrow | Token::FatArrow | Token::Dot | Token::Ampersand
        )
    }
}

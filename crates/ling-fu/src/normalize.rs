...
static BUILTINS_OTHER: &[Entry] = &[
    ...
    (
        ...
        ["keep_lights", "保灯", "ライト保持", "조명유지", "แสงเฟรมก่อน"],
    ),
    (
        &[
            "set_vertex_normals",
...
static BUILTINS_GAME: &[Entry] = &[
    ...
    (
        &["spawn", "生成", "スポーン", "생성", "สร้าง"],
        ["spawn", "生成", "スポーン", "생성", "สร้าง"],
    ),
    (
        &["destroy", "销毁", "破壊", "파괴", "ทำลาย"],
        ["destroy", "销毁", "破壊", "파괴", "ทำลาย"],
    ),
    (
...
static VOCABULARY: &[Entry] = &[
    ...
    // ── People / narrative ───────────────────────────────────────────────────
    (
        &["hero", "英雄", "ヒーロー", "영웅", "วีรบุรุษ"],
        ["hero", "英雄", "ヒーロー", "영웅", "วีรบุรุษ"],
    ),
    (
        &["demon", "恶魔", "デーモン", "악마", "ปีศาจ"],
        ["demon", "恶魔", "デーモン", "악마", "ปีศาจ"],
    ),
    (
        &["spirit", "精神", "スピリット", "정신", "วิญญาณ"],
        ["spirit", "精神", "スピリット", "정신", "วิญญาณ"],
    ),
    (
        &["soul", "灵魂", "ソウル", "영혼", "วิญญาณ"],
        ["soul", "灵魂", "ソウル", "영혼", "วิญญาณ"],
    ),
    (
        &["dream", "梦", "夢", "꿈", "ความฝัน"],
    ...
    (
        &["story", "故事", "ストーリー", "이야기", "เรื่องราว"],
        ["story", "故事", "ストーリー", "이야기", "เรื่องราว"],
    ),
    (
        &["chapter", "章", "チャプター", "챕터", "บท"],
        ["chapter", "章", "章", "장", "บท"],
    ),
    // ── Spatial / visual ─────────────────────────────────────────────────────
    (
    ...
    (
        ...
        ["character", "角色", "キャラクター", "캐릭터", "ตัวละคร"],
    ),
    (
        &["background", "背景", "背景", "배경", "พื้นหลัง"],
        ["background", "背景", "背景", "배경", "พื้นหลัง"],
    ),
    (
        &["foreground", "前景", "前景", "전경", "พื้นหน้า"],
        ["foreground", "前景", "前景", "전경", "พื้นหน้า"],
    ),
    (
        &["ui", "界面", "UI", "인터페이스", "ส่วนติดต่อ", "interface"],
        ["ui", "界面", "UI", "인터페이스", "ส่วนติดต่อ"],
    ),
    (
        &["dialog", "对话", "ダイアログ", "다이얼로그", "ไดอะล็อก"],
        ["dialog", "对话", "ダイアログ", "다이얼로그", "ไดอะล็อก"],
    ),
    (
        &[
        ...
        ["effect", "效果", "エフェクต", "효과", "เอฟเฟกต์"],
    ),
    (
        &["system", "系统", "システム", "시스템", "ระบบ", "systems"],
        ["system", "系统", "システム", "시스템", "ระบบ"],
    ),
    (
        &[
    ...
    (
        &["scene", "场景", "シーン", "장면", "ฉาก", "scenes", "情景"],
        ["scene", "场景", "シーン", "장면", "ฉาก"],
    ),
    (
        &["screen", "屏幕", "スクリーン", "화면", "หน้าจอ", "screens"],
        ["screen", "屏幕", "スクリーン", "화면", "หน้าจอ"],
    ),
    (
        &[
            "quest",
    ...
    (
        ...
        ["cutscene", "过场动画", "カットシーン", "컷씬", "คัตซีน"],
    ),
    (
        &["dialogue", "对话", "ダイアログ", "대화", "บทสนทนา"],
        ["dialogue", "对话", "ダイアログ", "대화", "บทสนทนา"],
    ),
    (
        &[
    ...
    (
        &["terrain", "地形", "地形", "지형", "ภูมิประเทศ"],
        ["terrain", "地形", "地形", "지형", "ภูมิประเทศ"],
    ),
    (
        &["prefab", "预制体", "プレハブ", "프리팹", "พรีแฟบ", "prefabs"],
        ["prefab", "预制体", "プレハブ", "프리팹", "พรีแฟบ"],
    ),
    (
        &[
            "resource",
        ...
        ["resource", "资源", "リソース", "리소스", "ทรัพยากร"],
    ),
    (
        &["project", "项目", "プロジェクト", "프로젝트", "โปรเจกต์"],
        ["project", "项目", "プロジェクト", "프로젝트", "โปรเจกต์"],
    ),
    (
        &["demo", "演示", "デモ", "데모", "สาธิต", "demos"],
        ["demo", "演示", "デモ", "데모", "สาธิต"],
    ),
    (
        &["chapter", "章", "章", "장", "บท", "chapters", "話"],
        ["chapter", "章", "章", "장", "บท"],
    ),
    (
        &["act", "幕", "幕", "막", "ตอน", "acts"],

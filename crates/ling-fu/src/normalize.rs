...
static BUILTINS_OTHER: &[Entry] = &[
    ...
    (&["set_camera_pos","摄像机位置","カメラ位置","카메라위치","ตั้งตำแหน่งกล้อง"],["set_camera_pos","摄像机位置","カメラ位置","카메라위치","ตั้งตำแหน่งกล้อง"]),
    (&["set_zdist","设置深度","奥行き設定","깊이설정","ตั้งระยะห่าง"],["set_zdist","设置深度","奥行き設定","깊이설정","ตั้งระยะห่าง"]),
    ...
    (&["clear_lights","清除灯光","ライトクリア","조명초기화","ล้างแสง"],["clear_lights","清除灯光","ライトクリア","조명초기화","ล้างแสง"]),
    (&["draw_triangle_3d","绘制三角形","三角形描画","삼각형그리기","วาดสามเหลี่ยม"],["draw_triangle_3d","绘制三角形","三角形描画","삼각形그리기","วาดสามเหลี่ยม"]),
    (&["draw_line_3d","绘制线条","線描画","선그리기","วาดเส้น"],     ["draw_line_3d","绘制线条","線描画","선그리기","วาดเส้น"]),
    (&["open_fullscreen","打开全屏","全画面を開く","전체화면열기","เปิดหน้าต่างเต็มจอ"],["open_fullscreen","打开全屏","全画面を開く","전체화면열기","เปิดหน้าต่างเต็มจอ"]),
    (&["window_is_open","窗口打开","ウィンドウが開いている","창이열려있음","หน้าต่างเปิดอยู่"],["window_is_open","窗口打开","ウィンドウが開いている","창이열려있음","หน้าต่างเปิดอยู่"]),
    (&["capture_mouse","捕获鼠标","マウスをキャプチャ","마우스캡처","จับเมาส์"],["capture_mouse","捕获鼠标","マウスをキャプチャ","마우스캡처","จับเมาส์"]),
    (&["clear","清空","クリア","지우기","เติม"],                        ["clear","清空","クリア","지우기","เติม"]),

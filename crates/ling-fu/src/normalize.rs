...
static KEYWORDS: &[Entry] = &[
    (
        &["fn", "函", "関数", "関", "함수", "ฟังก์ชัน"],
        ["fn", "函", "関数", "함수", "ฟังก์ชัน"],
    ),
    (
        &["bind", "let", "令", "束縛", "バ", "바인드", "묶", "ผูก"],
        ["bind", "令", "束縛", "바인드", "ผูก"],
    ),
    (
        &["do", "执", "実行", "執", "실행", "ทำ"],
    ...
    (
        &["mod", "核", "モジュール", "模", "모듈", "โมดูล"],
        ["mod", "核", "モジュール", "모듈", "โมดูล"],
    ),
    (
        &["use", "载", "引", "사용", "使う", "ใช้", "นำเข้า"],
        ["use", "载", "使う", "사용", "ใช้"],
    ),
    (
        &["if", "若", "如", "もし", "만약", "조건", "ถ้า"],
    ...
    (
        &["else", "否则", "否", "他", "아니면", "มิฉะนั้น"],
        ["else", "否则", "他", "아니면", "มิฉะนั้น"],
    ),
    (
        &["while", "循", "当", "間", "一方", "동안", "반복", "ขณะที่"],
        ["while", "循", "間", "동안", "ขณะที่"],
    ),
    (
        &["for", "历", "繰", "ために", "위해", "สำหรับ"],
        ["for", "历", "繰", "위해", "สำหรับ"],
    ),
    (
        &["in", "于", "の中", "안에", "ใน"],
    ...
    (
        &["match", "配", "一致", "매치", "จับคู่"],
        ["match", "配", "一致", "매치", "จับคู่"],
    ),
    (
        &["return", "归", "戻る", "帰る", "반환", "귀환", "คืน"],
        ["return", "归", "戻る", "반환", "คืน"],
    ),
    (
        &["async", "异步", "异", "非同期", "비동기", "ไม่พร้อมกัน"],
        ["async", "异步", "非同期", "비동기", "ไม่พร้อมกัน"],
    ),
    (
        &["wait", "等待", "待", "待つ", "기다려", "รอ"],
        ["wait", "等待", "待つ", "기다려", "รอ"],
    ...
    (
        &["stop", "停止", "止", "止まれ", "停め", "멈춤", "หยุด"],
        ["stop", "停止", "止まれ", "멈춤", "หยุด"],
    ),
    (
        &["again", "继续", "継続", "계속", "อีกครั้ง"],
        ["again", "继续", "継続", "계속", "อีกครั้ง"],
    ),
    (
        &["spawn", "生成", "启", "起動", "생성", "สร้าง"],
        ["spawn", "生成", "起動", "생성", "สร้าง"],
    ),
    (
        &["own", "拥有", "独", "所有", "소유", "เป็นเจ้าของ"],
        ["own", "拥有", "所有", "소유", "เป็นเจ้าของ"],
    ),
    (
        &["lend", "借", "借りる", "빌려", "ยืม"],
        ["lend", "借", "借りる", "빌려", "ยืม"],
    ...
    (
        &["share", "共享", "共", "共有", "공유", "แชร์"],
        ["share", "共享", "共有", "공유", "แชร์"],
    ),
    (
        &["move", "移动", "移", "移動", "이동", "ย้าย"],
        ["move", "移动", "移動", "이동", "ย้าย"],
    ),
    (
        &["copy", "复制", "复", "コピー", "복사", "คัดลอก"],
        ["copy", "复制", "コピー", "복사", "คัดลอก"],
    ),
    (
        &["as", "为", "として", "로서", "เป็น"],
        ["as", "为", "として", "로서", "เป็น"],
...
static BUILTINS_VTEX: &[Entry] = &[
    ...
    (
        &["vtex_rings", "ลายวงซ้อน", "纹环", "リング模様", "링무늬"],
        ["vtex_rings", "纹环", "リング模様", "링무늬", "ลายวงซ้อน"],
    ),
    (
        &["vtex_spiral", "ลายเกลียว", "纹螺", "螺旋模様", "나선무늬"],
        ["vtex_spiral", "纹螺", "螺旋模様", "나선무늬", "ลายเกลียว"],
    ),
    (
    ...
    (
        ...
        ["vtex_flower", "纹花", "花模様", "꽃무늬", "ลายดอกไม้"],
    ),
    (
    ...
    (
        &["vtex_rain", "ลายฝน", "纹雨", "雨模様", "비무늬"],
        ["vtex_rain", "纹雨", "雨模様", "비무늬", "ลายฝน"],
    ),
    (
        &[
            "vtex_halftone",
    ...
    (
        &["vtex_pagoda", "ลายเจดีย์", "纹塔", "塔", "탑", "เจดีย์"],
...
static BUILTINS_OTHER: &[Entry] = &[
    ...
    (
        &["present", "呈现", "表示", "표시", "แสดง", "แสดงผล", "显"],
    ...
    (
        &["audio_bgm", "背景乐", "BGM", "배경음악", "เพลงประกอบ"],
        ["audio_bgm", "背景乐", "BGM", "배경음악", "เพลงประกอบ"],
    ),
    (
        &[
    ...
    (
        &["hsl_color", "色相色", "HSL色", "HSL색", "สีHSL"],
        ["hsl_color", "色相色", "HSL色", "HSL색", "สีHSL"],
    ),
    (
        &["print", "打印", "印刷", "출력", "พิมพ์"],
        ["print", "打印", "印刷", "출력", "พิมพ์"],
    ),
    (
        &["sqrt", "平方根", "平方根", "제곱근", "รากที่สอง"],
        ["sqrt", "平方根", "平方根", "제곱근", "รากที่สอง"],
    ),
    (
        &["abs", "绝对值", "絶対値", "절댓값", "ค่าสัมบูรณ์"],
        ["abs", "绝对值", "絶対値", "절댓값", "ค่าสัมบูรณ์"],
    ),
    (
        &["sin", "正弦", "サイン", "사인", "ไซน์"],
    ...
    (
        &["cos", "余弦", "コサイン", "코사인", "โคไซน์"],
        ["cos", "余弦", "コサイン", "코사인", "โคไซน์"],
    ),
    (
        &["int", "取整", "整数", "정수", "ตัดทศนิยม"],
        ["int", "取整", "整数", "정수", "ตัดทศนิยม"],
    ),
    (
    ...
    (
        &["floor", "向下取整", "床関数", "내림", "ปัดลง"],
        ["floor", "向下取整", "床関数", "내림", "ปัดลง"],
    ),
    (
        &["ceil", "向上取整", "天井関数", "올림", "ปัดขึ้น"],
        ["ceil", "向上取整", "天井関数", "올림", "ปัดขึ้น"],
    ),
    (
        &["rand", "随机", "乱数", "무작위", "สุ่ม"],
    ...
    (
        &["now", "当前时间", "現在時刻", "현재시간", "เวลาปัจจุบัน"],
        ["now", "当前时间", "現在時刻", "현재시간", "เวลาปัจจุบัน"],
    ),
];
...
static BUILTINS_AUDIO: &[Entry] = &[
    ...
    (
        &["list_new", "新建列表", "新規リスト", "새목록", "รายการใหม่"],
        ["list_new", "新建列表", "新規リスト", "새목록", "รายการใหม่"],
    ),
    (
        &[
    ...
    (
        &["list_get", "取元素", "要素取得", "요소가져오기", "รับรายการ"],
        ["list_get", "取元素", "要素取得", "요소가져오기", "รับรายการ"],
    ),
...
static BUILTINS_MATH: &[Entry] = &[
    (
        &["format", "格式", "フォーマット", "서식", "รูปแบบ"],
        ["format", "格式", "フォーマット", "서식", "รูปแบบ"],
    ),
    (
        &["tan", "正切", "タンジェント", "탄젠트", "แทนเจนต์"],
        ["tan", "正切", "タンジェント", "탄젠트", "แทนเจนต์"],
    ),
    (
        &["asin", "反正弦", "アークサイン", "아크사인", "อาร์กไซน์"],
        ["asin", "反正弦", "アークサイン", "아크사인", "อาร์กไซน์"],
    ),
    (
        &[
    ...
    (
        &["cbrt", "立方根", "立方根", "세제곱근", "รากที่สาม"],
        ["cbrt", "立方根", "立方根", "세제곱근", "รากที่สาม"],
    ),
    (
        &["log", "ln", "对数", "対数", "로그", "ลอการิทึม"],
        ["log", "对数", "対数", "로그", "ลอการิทึม"],
    ),
    (
        &["round", "四舍五入", "四捨五入", "반올림", "ปัดเศษ"],
        ["round", "四舍五入", "四捨五入", "반올림", "ปัดเศษ"],
    ),
    (
...
static BUILTINS_CRYPTO: &[Entry] = &[
    ...
    (
        &["sha3_512", "SHA3-512", "SHA3-512", "SHA3-512", "SHA3-512"],
        ["sha3_512", "SHA3-512", "SHA3-512", "SHA3-512", "SHA3-512"],
    ),
    (
        &["shake256", "摇动256", "シェイク256", "셰이크256", "เชค256"],
        ["shake256", "摇动256", "シェイク256", "셰이크256", "เชค256"],
    ),
    (
        &[
    ...
    (
        &["x25519", "X25519", "X25519", "X25519", "X25519"],
        ["x25519", "X25519", "X25519", "X25519", "X25519"],
    ),
    (
        &[
    ...
    (
        &["vrf_verify", "VRF验证", "VRF検証", "VRF검증", "VRFตรวจสอบ"],
        ["vrf_verify", "VRF验证", "VRF検証", "VRF검증", "VRFตรวจสอบ"],
    ),
    (
        &["hash", "哈希", "ハッシュ", "해시", "แฮช"],
    ...
    (
        &["derive", "推导", "導出", "유도", "สืบเนื่อง"],
        ["derive", "推导", "導出", "유도", "สืบเนื่อง"],
    ),
    (
        &["generate", "生成", "生成", "생성", "สร้าง"],
        ["generate", "生成", "生成", "생성", "สร้าง"],
    ),
];
...
static BUILTINS_GAME: &[Entry] = &[
    ...
    (
        &["key_released", "按键释放", "キー解放", "키떼임", "ปุ่มปล่อย"],
        ["key_released", "按键释放", "キー解放", "키떼임", "ปุ่มปล่อย"],
    ),
    (
        &[
    ...
    (
        &["windowed", "窗口", "ウィンドウ", "윈도우", "หน้าต่าง"],
        ["windowed", "窗口", "ウィンドウ", "윈도우", "หน้าต่าง"],
    ),
];
...
static VOCABULARY: &[Entry] = &[
    ...
    (
        ...
        ["audio", "音频", "音声", "오디오", "เสียง"],
    ),
    (
        &["font", "字体", "フォント", "폰트", "ฟอนต์", "fonts", "字型"],
        ["font", "字体", "フォント", "폰트", "ฟอนต์"],
    ),
    (
        &[
            "image",
    ...
    (
        &["texture", "纹理", "テクスチャ", "텍스처", "พื้นผิว"],
        ["texture", "纹理", "テクスチャ", "텍스처", "พื้นผิว"],
    ),
    (
        &["shader", "着色器", "シェーダー", "쉐이더", "เชดเดอร์"],
        ["shader", "着色器", "シェーダー", "쉐이더", "เชดเดอร์"],
    ),
    (
        &[
    ...
    (
        &[
            "color", "颜色", "色", "색상", "สี", "colour", "colours", "colors",
        ],
        ["color", "颜色", "色", "색상", "สี"],
    ),
    (
        &["shape", "形状", "形", "모양", "รูปทรง", "shapes"],
        ["shape", "形状", "形", "모양", "รูปทรง"],
    ),
    (
        &[
            "symbol",
        ...
        ["symbol", "符号", "シンボル", "심볼", "สัญลักษณ์"],
    ),
    (
        &["text", "文字", "テキスト", "텍스트", "ข้อความ", "texts"],
        ["text", "文字", "テキスト", "텍스트", "ข้อความ"],
    ),
    (
        &["glyph", "字形", "グリフ", "글리프", "ตัวอักษร", "glyphs"],
        ["glyph", "字形", "グリフ", "글리프", "ตัวอักษร"],
    ),
    (
        &["icon", "图标", "アイコン", "아이콘", "ไอคอน", "icons"],
        ["icon", "图标", "アイコン", "아이콘", "ไอคอน"],
    ),
    // ── Music / audio domain ─────────────────────────────────────────────────
    (
        &["melody", "旋律", "メロディ", "멜로디", "ทำนอง"],
        ["melody", "旋律", "メロディ", "멜로디", "ทำนอง"],
    ),
    (
        &["rhythm", "节奏", "リズム", "리듬", "จังหวะ"],
        ["rhythm", "节奏", "リズム", "리듬", "จังหวะ"],
    ),
    (
        &["harmony", "和声", "ハーモニー", "화음", "ความสอดคล้อง"],
        ["harmony", "和声", "ハーモニー", "화음", "ความสอดคล้อง"],
    ),
    (
        &["beat", "节拍", "ビート", "박자", "บีต"],
    ...
    (
        &["chord", "和弦", "コード", "코드", "คอร์ด"],
        ["chord", "和弦", "コード", "코드", "คอร์ด"],
    ),
    (
        &["scale", "音阶", "スケール", "음계", "สเกล"],
        ["scale", "音阶", "スケール", "음계", "สเกล"],
    ),
    (
        &["track", "音轨", "トラック", "트랙", "แทร็ก"],
        ["track", "音轨", "トラック", "트랙", "แทร็ก"],
    ),
    (
        &["sample", "采样", "サンプル", "샘플", "ตัวอย่าง"],
        ["sample", "采样", "サンプル", "샘플", "ตัวอย่าง"],
    ),
    (
        &[
    ...
    (
        &["treble", "高音", "トレブル", "트레블", "เทรเบิล"],
        ["treble", "高音", "トレブル", "트레블", "เทรเบิล"],
    ),
    (
        &["piano", "钢琴", "ピアノ", "피아노", "เปียโน"],
        ["piano", "钢琴", "ピアノ", "피아노", "เปียโน"],
    ),
    (
        &["drum", "鼓", "ドラム", "드럼", "กลอง", "drums"],
        ["drum", "鼓", "ドラム", "드럼", "กลอง"],
    ),
    (
        &["instrument", "乐器", "楽器", "악기", "เครื่องดนตรี"],
        ["instrument", "乐器", "楽器", "악기", "เครื่องดนตรี"],
    ),
    (
        &["symphony", "交响乐", "シンフォニー", "교향악", "ซิมโฟนี"],
        ["symphony", "交响乐", "シンフォニー", "교향악", "ซิมโฟนี"],
    ),
    (
        &["concert", "音乐会", "コンサート", "콘서트", "คอนเสิร์ต"],
        ["concert", "音乐会", "コンサート", "콘서트", "คอนเสิร์ต"],
    ),
    // ── Game domain ──────────────────────────────────────────────────────────
    (
    ...
    (
        &["player", "玩家", "プレイヤー", "플레이어", "ผู้เล่น"],
        ["player", "玩家", "プレイヤー", "플레이어", "ผู้เล่น"],
    ),
    (
        &["enemy", "敌人", "敵", "적", "ศัตรู", "enemies"],
        ["enemy", "敌人", "敵", "적", "ศัตรู"],
    ),
    (
        &["boss", "首领", "ボス", "보스", "บอส"],
    ...
    (
        &["level", "等级", "レベル", "레벨", "ระดับ", "levels"],
        ["level", "等级", "レベル", "레벨", "ระดับ"],
    ),
    (
        &["stage", "阶段", "ステージ", "스테이지", "ด่าน", "stages"],
        ["stage", "阶段", "ステージ", "스테이지", "ด่าน"],
    ),
    (
        &["score", "分数", "スコア", "점수", "คะแนน"],
        ["score", "分数", "スコア", "점수", "คะแนน"],
    ),
    (
        &["life", "生命", "ライフ", "생명", "ชีวิต"],
        ["life", "生命", "ライフ", "생명", "ชีวิต"],
    ),
    (
        &["health", "健康", "ヘルス", "체력", "สุขภาพ"],
        ["health", "健康", "ヘルス", "체력", "สุขภาพ"],
    ),
    (
        &["inventory", "库存", "インベントリ", "인벤토리", "ไอเทม"],
        ["inventory", "库存", "インベントリ", "인벤토리", "ไอเทม"],
    ),
    (
        &["map", "地图", "マップ", "지도", "แผนที่"],
        ["map", "地图", "マップ", "지도", "แผนที่"],
    ),
    (
        &["world", "世界", "世界", "세계", "โลก"],
    ...
    (
        &["play", "播放", "プレイ", "플레이", "เล่น"],
        ["play", "播放", "プレイ", "플레이", "เล่น"],
    ),
    (
        &["title", "标题", "タイトル", "제목", "ชื่อเรื่อง"],
        ["title", "标题", "タイトル", "제목", "ชื่อเรื่อง"],
    ),
    (
        &["menu", "菜单", "メニュー", "메뉴", "เมนู"],
        ["menu", "菜单", "メニュー", "메뉴", "เมนู"],
    ),
    (
        &["pause", "暂停", "ポーズ", "일시정지", "หยุดชั่วคราว"],
        ["pause", "暂停", "ポーズ", "일시정지", "หยุดชั่วคราว"],
    ),
    (
        &["win", "胜利", "ウィン", "승리", "ชนะ"],
    ...
    (
        &["output", "输出", "アウトプット", "출력", "เอาต์พุต"],
        ["output", "输出", "アウトプット", "출력", "เอาต์พุต"],
    ),
    (
        &["physics", "物理", "物理", "물리", "ฟิสิกส์"],
        ["physics", "物理", "物理", "물리", "ฟิสิกส์"],
    ),
    (
        &["collider", "碰撞器", "コライダー", "충돌체", "คอลไลเดอร์"],
    ...
    // ── Project structure ────────────────────────────────────────────────────
    (
        &["src", "源码", "ソース", "소스", "ต้นฉบับ", "source"],
        ["src", "源码", "ソース", "소스", "ต้นฉบับ"],
    ),
    (
        &["lib", "库", "ライブラリ", "라이브러리", "ไลบรารี", "library"],
        ["lib", "库", "ライブラリ", "라이브러리", "ไลบรารี"],
    ),
    (
        &["tests", "测试", "テスト", "테스트", "ทดสอบ", "test"],
        ["tests", "测试", "テスト", "테스트", "ทดสอบ"],
    ),
    (
        &["examples", "示例", "サンプル", "예제", "ตัวอย่าง", "example"],
        ["examples", "示例", "サンプル", "예제", "ตัวอย่าง"],
    ),
    (
        &["docs", "文档", "ドキュメント", "문서", "เอกสาร", "doc"],
        ["docs", "文档", "ドキュメント", "문서", "เอกสาร"],
    ),
    (
        &["assets", "资源", "アセット", "에셋", "ทรัพยากร", "asset"],
        ["assets", "资源", "アセット", "에셋", "ทรัพยากร"],
    ),
    (
        &[
            "config",
        ...
        ["config", "配置", "設定", "설정", "ตั้งค่า"],
    ),
    (
        &["build", "构建", "ビルド", "빌드", "สร้าง"],
        ["build", "构建", "ビルド", "빌드", "สร้าง"],
    ),
    (
        &["tools", "工具", "ツール", "도구", "เครื่องมือ", "tool"],
        ["tools", "工具", "ツール", "도구", "เครื่องมือ"],
    ),
    (
        &[
            "scripts",
        ...
        ["scripts", "脚本", "スクリプト", "스크립트", "สคริปต์"],
    ),
    (
        &["data", "数据", "データ", "데이터", "ข้อมูล"],
        ["data", "数据", "データ", "데이터", "ข้อมูล"],
    ),
    (
        &["scenes", "场景", "シーン", "장면", "ฉาก", "scene"],
        ["scenes", "场景", "シーン", "장면", "ฉาก"],
    ),
    (
        &["rooms", "房间", "部屋", "방", "ห้อง", "room"],
        ["rooms", "房间", "部屋", "방", "ห้อง"],
    ),
    (
        &["gallery", "画廊", "ギャラリー", "갤러리", "แกลเลอรี"],
        ["gallery", "画廊", "ギャラリー", "갤러리", "แกลเลอรี"],
    ),
    (
        &["misc", "其他", "その他", "기타", "อื่นๆ", "other", "others"],
        ["misc", "其他", "その他", "기타", "อื่นๆ"],
    ),
    (
        &["shared", "共享", "共有", "공유", "ร่วมกัน"],
        ["shared", "共享", "共有", "공유", "ร่วมกัน"],
    ),
    (
        &["common", "通用", "共通", "공통", "ทั่วไป"],
        ["common", "通用", "共通", "공통", "ทั่วไป"],
    ),
    // ── People / narrative ───────────────────────────────────────────────────
    ...
    // ── Spatial / visual ─────────────────────────────────────────────────────
    (
        &["chakra", "脉轮", "チャクラ", "차크라", "จักร"],
        ["chakra", "脉轮", "チャクラ", "차크라", "จักร"],
    ),
    (
        &["lotus", "莲花", "蓮", "연꽃", "ดอกบัว"],
        ["lotus", "莲花", "蓮", "연꽃", "ดอกบัว"],
    ),
    (
        &["mandala", "曼陀罗", "マンダラ", "만다라", "มณฑล"],
        ["mandala", "曼陀罗", "マンダラ", "만다라", "มณฑล"],
    ),
    (
        &["spiral", "螺旋", "スパイラル", "나선", "เกลียว"],
        ["spiral", "螺旋", "スパイラル", "나선", "เกลียว"],
    ),
    (
        &["grid", "网格", "グリッド", "격자", "ตาราง"],
        ["grid", "网格", "グリッド", "격자", "ตาราง"],
    ),
    (
        &["wave", "波", "波", "파", "คลื่น"],
    ...
    (
        &["init", "初始化", "初期化", "초기화", "เริ่มต้น"],
        ["init", "初始化", "初期化", "초기화", "เริ่มต้น"],
    ),
    (
        &["setup", "设置", "セットアップ", "설정", "ตั้งค่า"],
        ["setup", "设置", "セットアップ", "설정", "ตั้งค่า"],
    ),
    (
        &["hello", "你好", "こんにちは", "안녕", "สวัสดี"],
        ["hello", "你好", "こんにちは", "안녕", "สวัสดี"],
    ),
    (
        &["core", "核心", "コア", "코어", "แกนกลาง"],
        ["core", "核心", "コア", "코어", "แกนกลาง"],
    ),
    (
        &[
        ...
        ["util", "工具", "ユーティリティ", "유틸", "ยูทิลิตี้"],
    ),
    (
        &["helper", "助手", "ヘルパー", "헬퍼", "ตัวช่วย", "helpers"],
        ["helper", "助手", "ヘルパー", "헬퍼", "ตัวช่วย"],
    ),
    (
        &["manager", "管理器", "マネージャー", "매니저", "ตัวจัดการ"],
        ["manager", "管理器", "マネージャー", "매니저", "ตัวจัดการ"],
    ),
    (
        &["loader", "加载器", "ローダー", "로더", "ตัวโหลด"],
        ["loader", "加载器", "ローダー", "로더", "ตัวโหลด"],
    ),
    (
        &["renderer", "渲染器", "レンダラー", "렌더러", "ตัวเรนเดอร์"],
        ["renderer", "渲染器", "レンダラー", "렌더러", "ตัวเรนเดอร์"],
    ),
    (
        &["parser", "解析器", "パーサー", "파서", "ตัวแยกวิเคราะห์"],
        ["parser", "解析器", "パーサー", "파서", "ตัวแยกวิเคราะห์"],
    ),
    (
        &["router", "路由器", "ルーター", "라우터", "เราเตอร์"],
        ["router", "路由器", "ルーター", "라우터", "เราเตอร์"],
    ),
    (
        &["server", "服务器", "サーバー", "서버", "เซิร์ฟเวอร์"],
        ["server", "服务器", "サーバー", "서버", "เซิร์ฟเวอร์"],
    ),
    (
        &["client", "客户端", "クライアント", "클라이언트", "ไคลเอนต์"],
        ["client", "客户端", "クライアント", "클라이언트", "ไคลเอนต์"],
    ),
    (
        &["network", "网络", "ネットワーク", "네트워크", "เครือข่าย"],
        ["network", "网络", "ネットワーク", "네트워크", "เครือข่าย"],
    ),
    (
        &[
    ...
    (
        &["event", "事件", "イベント", "이벤트", "เหตุการณ์", "events"],
        ["event", "事件", "イベント", "이벤트", "เหตุการณ์"],
    ),
    (
        &["timer", "定时器", "タイマー", "타이머", "ตัวจับเวลา"],
        ["timer", "定时器", "タイマー", "타이머", "ตัวจับเวลา"],
    ),
    (
        &["math", "数学", "数学", "수학", "คณิตศาสตร์"],
        ["math", "数学", "数学", "수학", "คณิตศาสตร์"],
    ),

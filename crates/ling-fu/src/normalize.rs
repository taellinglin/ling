...
static BUILTINS_AUDIO: &[Entry] = &[
    ...
    (&["audio_sfx","音效","空間効果音","공간효과음","เสียงเอฟเฟกต์"],                    ["audio_sfx","音效","空間効果音","공간효과음","เสียงเอฟเฟกต์"]),
    (&["audio_sample_load","载入采样","サンプル読込","샘플로드","โหลดตัวอย่างเสียง"],     ["audio_sample_load","载入采样","サンプル読込","샘플로드","โหลดตัวอย่างเสียง"]),
    (&["audio_sample_play","播放采样","サンプル再生","샘플재생","เล่นตัวอย่างเสียง"],     ["audio_sample_play","播放采样","サンプル再生","샘플재생","เล่นตัวอย่างเสียง"]),
    (&["audio_sample_stop","停止采样","サンプル停止","샘플정지","หยุดตัวอย่างเสียง"],     ["audio_sample_stop","停止采样","サンプル停止","샘플정지","หยุดตัวอย่างเสียง"]),
    (&["audio_fx_delay","回声","ディレイ効果","딜레이","เสียงสะท้อน"],                  ["audio_fx_delay","回声","ディレイ効果","딜레이","เสียงสะท้อน"]),
    (&["audio_fx_reverb","混响","リバーブ","리버브","เสียงก้อง"],                       ["audio_fx_reverb","混响","リバーブ","리버브","เสียงก้อง"]),
    (&["audio_fx_lowpass","低通滤波","ローパス","저역통과","กรองความถี่ต่ำ"],            ["audio_fx_lowpass","低通滤波","ローパス","저역통과","กรองความถี่ต่ำ"]),
];
...
static BUILTINS_GFX: &[Entry] = &[
    ...
    (&["orb_shell","球壳","オーブ殻","오브껍질","เปลือกทรงกลม"],           ["orb_shell","球壳","オーブ殻","오브껍질","เปลือกทรงกลม"]),
    (&["orb_particles","球内粒子","オーブ粒子","오브입자","อนุภาคทรงกลม"],   ["orb_particles","球内粒子","オーブ粒子","오브입자","อนุภาคทรงกลม"]),
    ...
    (&["set_alpha","设透明","アルファ設定","투명도설정","ตั้งความโปร่งใส"],          ["set_alpha","设透明","アルファ設定","투명도설정","ตั้งความโปร่งใส"]),
    (&["grad_triangle","渐变三角","グラデ三角","그라데삼각","สามเหลี่ยมไล่สี"],       ["grad_triangle","渐变三角","グラデ三角","그라데삼각","สามเหลี่ยมไล่สี"]),
    (&["grad_rect","渐变矩形","グラデ矩形","그라데사각","สี่เหลี่ยมไล่สี"],            ["grad_rect","渐变矩形","グラデ矩形","그라데사각","สี่เหลี่ยมไล่สี"]),
    (&["shadow_blob","阴影斑","影ブロブ","그림자블롭","เงาวงรี"],                    ["shadow_blob","阴影斑","影ブロブ","그림자블롭","เงาวงรี"]),
    (&["cast_shadow","投射阴影","影を落とす","그림자드리우기","ทอดเงา"],              ["cast_shadow","投射阴影","影を落とす","그림자드리우기","ทอดเงา"]),
    (&["shadow_params","阴影参数","影設定","그림자설정","ตั้งค่าเงา"],                ["shadow_params","阴影参数","影設定","그림자설정","ตั้งค่าเงา"]),
    (&["depth_triangle","深度三角","深度三角形","깊이삼각","สามเหลี่ยมเรียงลึก"],      ["depth_triangle","深度三角","深度三角形","깊이삼각","สามเหลี่ยมเรียงลึก"]),
    (&["depth_line","深度线","深度線","깊이선","เส้นเรียงลึก"],                       ["depth_line","深度线","深度線","깊이선","เส้นเรียงลึก"]),
    // 2030 compositing: linear-light blending, OkLab gradients, z-buffer
    (&["set_color_space","色彩空间","色空間","색공간","ปริภูมิสี"],                    ["set_color_space","色彩空间","色空間","색공간","ปริภูมิสี"]),
    (&["set_gradient_space","渐变空间","グラデ空間","그라데이션공간","ปริภูมิไล่สี"],   ["set_gradient_space","渐变空间","グラデ空間","그라데이션공간","ปริภูมิไล่สี"]),
    (&["mix_color","混合颜色","色混合","색혼합","ผสมสี"],                              ["mix_color","混合颜色","色混合","색혼합","ผสมสี"]),
    (&["set_depth_test","深度测试","深度テスト","깊이테스트","ทดสอบความลึก"],           ["set_depth_test","深度测试","深度テスト","깊이테스트","ทดสอบความลึก"]),
];
...
static BUILTINS_UI: &[Entry] = &[
    ...
    (&["ui_theme","界面主题","UIテーマ","인터페이스테마","ธีมส่วนติดต่อ"],          ["ui_theme","界面主题","UIテーマ","인터페이스테마","ธีมส่วนติดต่อ"]),
    (&["ui_text","界面文字","UI文字","UI텍스트","ข้อความหน้าจอ"],                  ["ui_text","界面文字","UI文字","UI텍스트","ข้อความหน้าจอ"]),
    (&["ui_frame","边框","フレーム枠","프레임틀","กรอบ"],                          ["ui_frame","边框","フレーム枠","프레임틀","กรอบ"]),
    (&["ui_bevel","斜角框","ベベル枠","베벨틀","กรอบเฉียง"],                       ["ui_bevel","斜角框","ベベル枠","베벨틀","กรอบเฉียง"]),
    (&["ui_hot","热区","ホットエリア","핫존","พื้นที่สัมผัส"],                     ["ui_hot","热区","ホットエリア","핫존","พื้นที่สัมผัส"]),
    // HUD
    (&["ui_radar","雷达","レーダー","레이더","เรดาร์"],                            ["ui_radar","雷达","レーダー","레이더","เรดาร์"]),
    (&["ui_compass","罗盘","コンパス","나침반","เข็มทิศ"],                         ["ui_compass","罗盘","コンパス","나침반","เข็มทิศ"]),
    (&["ui_reticle","准星","照準","조준선","เป้าเล็ง"],                            ["ui_reticle","准星","照準","조준선","เป้าเล็ง"]),
    (&["ui_target","锁定框","ターゲット","표적","กรอบเป้า"],                       ["ui_target","锁定框","ターゲット","표적","กรอบเป้า"]),
    (&["ui_panel","面板","パネル","패널","แผง"],                                  ["ui_panel","面板","パネル","패널","แผง"]),
    (&["ui_scanlines","扫描线","走査線","스캔라인","เส้นสแกน"],                    ["ui_scanlines","扫描线","走査線","스캔라인","เส้นสแกน"]),
    // meters
    (&["ui_bar","进度条","バー","막대","แถบ"],                                    ["ui_bar","进度条","バー","막대","แถบ"]),
    (&["ui_segbar","分段条","分割バー","분할막대","แถบแบ่ง"],                       ["ui_segbar","分段条","分割バー","분할막대","แถบแบ่ง"]),
    (&["ui_gauge","仪表","ゲージ","게이지","มาตรวัด"],                            ["ui_gauge","仪表","ゲージ","게이지","มาตรวัด"]),
    (&["ui_ring","环表","リングメーター","링미터","วงแหวนวัด"],                    ["ui_ring","环表","リングメーター","링미터","วงแหวนวัด"]),
    (&["ui_vu","音量条","VUメーター","음량막대","มาตรเสียง"],                      ["ui_vu","音量条","VUメーター","음량막대","มาตรเสียง"]),
    (&["ui_spark","迷你图","スパークライン","스파크라인","กราฟจิ๋ว"],              ["ui_spark","迷你图","スパークライン","스파크라인","กราฟจิ๋ว"]),
    (&["ui_battery","电池","バッテリー","배터리","แบตเตอรี่"],                     ["ui_battery","电池","バッテリー","배터리","แบตเตอรี่"]),
    // interface controls
    (&["ui_button","按钮","ボタン","버튼","ปุ่ม"],                                ["ui_button","按钮","ボタン","버튼","ปุ่ม"]),
    (&["ui_toggle","开关","トグル","토글","สวิตช์"],                              ["ui_toggle","开关","トグル","토글","สวิตช์"]),
    (&["ui_slider","滑块","スライダー","슬라이더","แถบเลื่อน"],                     ["ui_slider","滑块","スライダー","슬라이더","แถบเลื่อน"]),
    (&["ui_checkbox","复选框","チェックボックス","체크박스","ช่องเลือก"],          ["ui_checkbox","复选框","チェックボックス","체크박스","ช่องเลือก"]),
    (&["ui_tabs","标签页","タブ","탭","แท็บ"],                                    ["ui_tabs","标签页","タブ","탭","แท็บ"]),
    (&["ui_progress","进度","プログレス","진행바","ความคืบหน้า"],                  ["ui_progress","进度","プログレス","진행바","ความคืบหน้า"]),
    (&["ui_tooltip","提示框","ツールチップ","툴팁","คำแนะนำ"],                     ["ui_tooltip","提示框","ツールチップ","툴팁","คำแนะนำ"]),
    (&["ui_stepper","步进器","ステッパー","스테퍼","ตัวปรับค่า"],                  ["ui_stepper","步进器","ステッパー","스테퍼","ตัวปรับค่า"]),
    // game UI
    (&["ui_healthbar","血条","体力バー","체력바","แถบพลังชีวิต"],                  ["ui_healthbar","血条","体力バー","체력바","แถบพลังชีวิต"]),
    (&["ui_cooldown","冷却","クールダウン","쿨다운","คูลดาวน์"],                   ["ui_cooldown","冷却","クールダウン","쿨다운","คูลดาวน์"]),
    (&["ui_counter","计数器","カウンター","카운터","ตัวนับ"],                      ["ui_counter","计数器","カウンター","카운터","ตัวนับ"]),
    (&["ui_minimap","小地图","ミニマップ","미니맵","แผนที่ย่อ"],                   ["ui_minimap","小地图","ミニマップ","미니맵","แผนที่ย่อ"]),
    (&["ui_dpad","方向键","方向パッド","방향패드","ปุ่มทิศทาง"],                   ["ui_dpad","方向键","方向パッド","방향패드","ปุ่มทิศทาง"]),
    (&["ui_slotgrid","物品格","スロットグリッド","슬롯격자","ช่องไอเทม"],          ["ui_slotgrid","物品格","スロットグリッド","슬롯격자","ช่องไอเทม"]),
    (&["ui_vignette","暗角","ビネット","비네트","ขอบมืด"],                        ["ui_vignette","暗角","ビネット","비네트","ขอบมืด"]),
    // faux-3D
    (&["ui_gauge3d","立体仪表","立体ゲージ","입체게이지","มาตรวัด3มิติ"],          ["ui_gauge3d","立体仪表","立体ゲージ","입체게이지","มาตรวัด3มิติ"]),
    (&["ui_panel3d","立体面板","立体パネル","입체패널","แผง3มิติ"],                ["ui_panel3d","立体面板","立体パネル","입체패널","แผง3มิติ"]),
    (&["ui_radar3d","立体雷达","立体レーダー","입체레이더","เรดาร์3มิติ"],          ["ui_radar3d","立体雷达","立体レーダー","입체레이더","เรดาร์3มิติ"]),
    // interface sounds
    (&["audio_blip","提示音","ビープ音","효과음","เสียงบี๊บ"],                     ["audio_blip","提示音","ビープ音","효과음","เสียงบี๊บ"]),
    (&["ui_sound","界面音","UI音","인터페이스음","เสียงปุ่ม"],                     ["ui_sound","界面音","UI音","인터페이스음","เสียงปุ่ม"]),
    // vector fonts (runtime arms already 5-language)
    (&["font_load","加载字体","フォント読込","글꼴로드","โหลดฟอนต์"],              ["font_load","加载字体","フォント読込","글꼴로드","โหลดฟอนต์"]),
    (&["font_text","字体文本","フォント文字","글꼴텍스트","ข้อความฟอนต์"],          ["font_text","字体文本","フォント文字","글꼴텍스트","ข้อความฟอนต์"]),
    (&["font_text_fill","填充字体","フォント塗り","글꼴채움","เติมฟอนต์"],          ["font_text_fill","填充字体","フォント塗り","글꼴채움","เติมฟอนต์"]),
    (&["font_text_3d","字体3D","フォント3D","글꼴3D","ข้อความฟอนต์3มิติ"],         ["font_text_3d","字体3D","フォント3D","글꼴3D","ข้อความฟอนต์3มิติ"]),
    (&["font_width","字体宽度","フォント幅","글꼴너비","ความกว้างฟอนต์"],          ["font_width","字体宽度","フォント幅","글꼴너비","ความกว้างฟอนต์"]),
];

// Builtins — music toolkit (ling-music): decode · analysis · GM synth · rhythm · karaoke
// Output forms MUST match the 5-language aliases in src/runtime/mod.rs.
static BUILTINS_MUSIC: &[Entry] = &[
    (&["music_load","载入音乐","音楽読込","음악로드","โหลดเพลง"],            ["music_load","载入音乐","音楽読込","음악로드","โหลดเพลง"]),
    (&["music_duration","音乐时长","音楽長さ","음악길이","ความยาวเพลง"],     ["music_duration","音乐时长","音楽長さ","음악길이","ความยาวเพลง"]),
    (&["music_bpm","节拍速度","テンポ","템포","จังหวะต่อนาที"],              ["music_bpm","节拍速度","テンポ","템포","จังหวะต่อนาที"]),
    (&["music_key","调性","調性","조성","คีย์เพลง"],                        ["music_key","调性","調性","조성","คีย์เพลง"]),
    (&["music_onsets","音符起点","オンセット","온셋","จุดเริ่มเสียง"],        ["music_onsets","音符起点","オンセット","온셋","จุดเริ่มเสียง"]),
    (&["music_beat_grid","节拍网格","ビートグリッド","비트그리드","กริดจังหวะ"],["music_beat_grid","节拍网格","ビートグリッド","비트그리드","กริดจังหวะ"]),
    (&["music_play","播放音乐","音楽再生","음악재생","เล่นเพลง"],            ["music_play","播放音乐","音楽再生","음악재생","เล่นเพลง"]),
    (&["music_pause","暂停音乐","音楽一時停止","음악일시정지","หยุดเพลงชั่วคราว"],["music_pause","暂停音乐","音楽一時停止","음악일시정지","หยุดเพลงชั่วคราว"]),
    (&["music_stop","停止音乐","音楽停止","음악정지","หยุดเพลง"],            ["music_stop","停止音乐","音楽停止","음악정지","หยุดเพลง"]),
    (&["music_seek","定位音乐","音楽シーク","음악탐색","ค้นหาเพลง"],          ["music_seek","定位音乐","音楽シーク","음악탐색","ค้นหาเพลง"]),
    (&["music_pos","音乐位置","音楽位置","음악위치","ตำแหน่งเพลง"],          ["music_pos","音乐位置","音楽位置","음악위치","ตำแหน่งเพลง"]),
    (&["music_volume","音乐音量","音楽音量","음악음량","ระดับเพลง"],         ["music_volume","音乐音量","音楽音量","음악음량","ระดับเพลง"]),
    (&["music_patch","乐器音色","音色読込","악기패치","แพตช์เครื่องดนตรี"],    ["music_patch","乐器音色","音色読込","악기패치","แพตช์เครื่องดนตรี"]),
    (&["music_note","弹音符","音符演奏","음표연주","เล่นโน้ต"],              ["music_note","弹音符","音符演奏","음표연주","เล่นโน้ต"]),
    (&["music_note_on","音符开始","音符オン","음표켜기","โน้ตเริ่ม"],         ["music_note_on","音符开始","音符オン","음표켜기","โน้ตเริ่ม"]),
    (&["music_note_off","音符结束","音符オフ","음표끄기","โน้ตจบ"],          ["music_note_off","音符结束","音符オフ","음표끄기","โน้ตจบ"]),
    (&["music_judge","判定","判定する","판정","ตัดสินจังหวะ"],              ["music_judge","判定","判定する","판정","ตัดสินจังหวะ"]),
    (&["music_grade_name","判定名","判定名称","판정이름","ชื่อการตัดสิน"],    ["music_grade_name","判定名","判定名称","판정이름","ชื่อการตัดสิน"]),
    (&["music_lrc","载入歌词","歌詞読込","가사로드","โหลดเนื้อเพลง"],        ["music_lrc","载入歌词","歌詞読込","가사로드","โหลดเนื้อเพลง"]),
    (&["music_lyric","当前歌词","現在歌詞","현재가사","เนื้อเพลงปัจจุบัน"],    ["music_lyric","当前歌词","現在歌詞","현재가사","เนื้อเพลงปัจจุบัน"]),
    (&["music_mic_pitch","麦克风音高","マイク音程","마이크음정","ระดับเสียงไมค์"],["music_mic_pitch","麦克风音高","マイク音程","마이크음정","ระดับเสียงไมค์"]),
    (&["music_note_name","音名","音名称","음이름","ชื่อโน้ต"],              ["music_note_name","音名","音名称","음이름","ชื่อโน้ต"]),
    (&["music_hz","音符频率","音符周波数","음표주파수","ความถี่โน้ต"],        ["music_hz","音符频率","音符周波数","음표주파수","ความถี่โน้ต"]),
    (&["music_pitch_score","音准评分","音程スコア","음정점수","คะแนนเสียง"],  ["music_pitch_score","音准评分","音程スコア","음정점수","คะแนนเสียง"]),
    (&["music_midi_load","载入MIDI","MIDI読込","미디로드","โหลดมิดี"],         ["music_midi_load","载入MIDI","MIDI読込","미디로드","โหลดมิดี"]),
    (&["music_midi_count","MIDI数量","MIDI数","미디수","จำนวนมิดี"],          ["music_midi_count","MIDI数量","MIDI数","미디수","จำนวนมิดี"]),
    (&["music_midi_notes","MIDI音符","MIDIノート","미디음표","โน้ตมิดี"],      ["music_midi_notes","MIDI音符","MIDIノート","미디음표","โน้ตมิดี"]),
    (&["music_midi_bars","MIDI音条","MIDIバー","미디바","แท่งมิดี"],          ["music_midi_bars","MIDI音条","MIDIバー","미디바","แท่งมิดี"]),
...
static BUILTINS_PHYSICS_FN: &[Entry] = &[
    ...
    (&["soft_spin","软体自旋","ソフト回転","소프트회전","หมุนนุ่ม"],           ["soft_spin","软体自旋","ソフト回転","소프트회전","หมุนนุ่ม"]),
    (&["soft_angular_speed","软体角速","ソフト角速度","소프트각속도","ความเร็วเชิงมุมนุ่ม"], ["soft_angular_speed","软体角速","ソフト角速度","소프트각속도","ความเร็วเชิงมุมนุ่ม"]),
    (&["liquid_mix","液体混合","液体混合度","액체혼합","การผสมของเหลว"],       ["liquid_mix","液体混合","液体混合度","액체혼합","การผสมของเหลว"]),

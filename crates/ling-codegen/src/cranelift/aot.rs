...
fn declare_runtime_functions(
    ...
    let runtime_fns: &[(&str, &[types::Type], types::Type)] = &[
        ...
        // UI themes (drivers::theme).
        ("ling_kernel_theme_count", &[], types::I64),
        ("ling_kernel_theme_current", &[], types::I64),
        ("ling_kernel_theme_select", &[types::I64], types::I64),
        ("ling_kernel_theme_name", &[types::I64], types::I64),
        ("ling_kernel_theme_color", &[types::I64], types::I64),
        // Rounded/blended framebuffer primitives.
        (
            "ling_kernel_fb_back_fill_rrect",
            &[
                types::I64,
                types::I64,
                types::I64,
        ...
        (
            "ling_kernel_fb_back_fill_circle",
            &[types::I64, types::I64, types::I64, types::I64],
            types::I64,
        ),
        (
            "ling_kernel_fb_back_blend_rect",
            &[
                types::I64,
                types::I64,
                types::I64,
        ...
        (
            "ling_kernel_fb_back_blend_rrect",
            &[
                types::I64,
                types::I64,
                types::I64,
        ...
        // Multi-window manager (drivers::wm).
        (
            "ling_kernel_wm_step",
            &[types::I64, types::I64, types::I64],
            types::I64,
        ),
        ("ling_kernel_wm_key", &[types::I64], types::I64),
        ("ling_kernel_wm_open", &[types::I64], types::I64),
        ("ling_kernel_wm_count", &[], types::I64),
        ("ling_kernel_wm_titlebar_h", &[], types::I64),
        ("ling_kernel_wm_slot_x", &[types::I64], types::I64),
        ("ling_kernel_wm_slot_y", &[types::I64], types::I64),
        ("ling_kernel_wm_slot_w", &[types::I64], types::I64),
        ("ling_kernel_wm_slot_h", &[types::I64], types::I64),
        ("ling_kernel_wm_slot_kind", &[types::I64], types::I64),
        ("ling_kernel_wm_slot_focused", &[types::I64], types::I64),
        ("ling_kernel_wm_slot_title", &[types::I64], types::I64),
        ("ling_kernel_wm_draw_content", &[types::I64], types::I64),
        ("ling_kernel_wm_dock_count", &[], types::I64),
        ("ling_kernel_wm_dock_x", &[types::I64], types::I64),
        ...
        ("ling_kernel_wm_draw_wallpaper", &[], types::I64),
        // Audio: AC'97 + OS mixer + pentatonic synth + tape player.
        ("ling_kernel_audio_init", &[], types::I64),
        ("ling_kernel_audio_pump", &[], types::I64),
        ("ling_kernel_audio_master", &[], types::I64),
        ("ling_kernel_audio_set_master", &[types::I64], types::I64),
        ("ling_kernel_audio_stream_count", &[], types::I64),
        ("ling_kernel_audio_stream_name", &[types::I64], types::I64),
        ("ling_kernel_audio_stream_volume", &[types::I64], types::I64),
        (
            "ling_kernel_audio_set_stream_volume",
            &[types::I64, types::I64],
            types::I64,
        ),
        ("ling_kernel_audio_exclusive_claim", &[types::I64], types::I64),
        ("ling_kernel_audio_exclusive_release", &[types::I64], types::I64),
        ("ling_kernel_audio_exclusive_holder", &[], types::I64),
        ("ling_kernel_audio_jingle", &[types::I64], types::I64),
        (
            "ling_kernel_audio_note",
            &[types::I64, types::I64, types::I64],
            types::I64,
        ),
        ("ling_kernel_sound_theme_count", &[], types::I64),
        ("ling_kernel_sound_theme_current", &[], types::I64),
        ("ling_kernel_sound_theme_select", &[types::I64], types::I64),
        ("ling_kernel_sound_theme_name", &[types::I64], types::I64),
        ("ling_kernel_player_load", &[types::I64, types::I64], types::I64),
        ("ling_kernel_player_play", &[], types::I64),
        ("ling_kernel_player_pause", &[], types::I64),
        ("ling_kernel_player_stop", &[], types::I64),
        ("ling_kernel_player_state", &[], types::I64),
        ("ling_kernel_player_pos_ms", &[], types::I64),
        ("ling_kernel_player_len_ms", &[], types::I64),
        ("ling_kernel_player_line", &[], types::I64),
        ("ling_kernel_wm_draw_tray", &[types::I64], types::I64),
        ("ling_kernel_boot_is_disk", &[], types::I64),
        ("ling_kernel_disk_name", &[], types::I64),
        ("ling_kernel_part_count", &[], types::I64),
        ("ling_kernel_part_label", &[types::I64], types::I64),
        ("ling_kernel_disk_erase_quick", &[], types::I64),
        ("ling_kernel_lingfu_sync", &[], types::I64),
        ("ling_kernel_lingfu_query", &[types::I64], types::I64),
        ("ling_kernel_lingfu_fetch_install", &[types::I64], types::I64),
        // Full kernel-side window render (bend + dissolve), wallpaper
        // image, browser, display modes, and the curl/download sinks.
        ("ling_kernel_wm_draw_window", &[types::I64], types::I64),
        ("ling_kernel_wm_set_wallpaper_image", &[types::I64], types::I64),
        ("ling_kernel_wm_draw_menu", &[], types::I64),
        ("ling_kernel_wm_logout_requested", &[], types::I64),
        ("ling_kernel_wm_clear_logout", &[], types::I64),
        ("ling_kernel_reboot", &[], types::I64),
        ("ling_kernel_poweroff", &[], types::I64),
        ("ling_kernel_browser_go", &[types::I64, types::I64], types::I64),
        ("ling_kernel_browser_status", &[], types::I64),
        ("ling_kernel_browser_dump", &[], types::I64),
        ("ling_kernel_display_count", &[], types::I64),
        ("ling_kernel_display_boot_apply", &[], types::I64),
        ("ling_kernel_display_preferred", &[], types::I64),
        ("ling_kernel_display_set", &[types::I64], types::I64),
        ("ling_kernel_display_name", &[types::I64], types::I64),
        ("ling_kernel_http_download", &[types::I64, types::I64], types::I64),
        ("ling_kernel_http_print", &[types::I64], types::I64),

...
impl Color {
    ...
    pub fn from_srgba(r: u8, g: u8, b: u8, a: u8) -> Self {
        Self::new(srgb_to_linear(r), srgb_to_linear(g), srgb_to_linear(b), a as f32 / 255.0)
    }
...
impl std::ops::Add for Color {
    type Output = Self;
    fn add(self, r: Self) -> Self { Self::new(self.r+r.r, self.g+r.g, self.b+r.b, self.a+r.a) }
}
impl std::ops::Mul for Color {
    type Output = Self;
    fn mul(self, r: Self) -> Self { Self::new(self.r*r.r, self.g*r.g, self.b*r.b, self.a*r.a) }
}
impl std::ops::Mul<f32> for Color {
    type Output = Self;
    fn mul(self, s: f32) -> Self { Self::new(self.r*s, self.g*s, self.b*s, self.a*s) }
}
    ...
    pub fn blend(self, src: Color, dst: Color) -> Color {
        ...
        match self {
            ...
            BlendMode::Overlay => {
                ...
                Color::new(ov(src.r, dst.r), ov(src.g, dst.g), ov(src.b, dst.b), (sa + da - sa * da).min(1.0))
            }
...
impl ColorGradient {
    ...
    pub fn sample(&self, t: f32) -> Color {
        if self.stops.is_empty() { return Color::TRANSPARENT; }
